...
<div class="info__section__support flex items-center justify-between gap-2 w-full mt-10">
    ...
    <div class="child__section flex justify-center sm:justify-end z-20">
      ...
      <div class="image__layout ">
        <img src="/images/photo_2024-09-19_10-47-37.jpg" alt="" class="border rounded " />
      </div>

    <div class="trust_container  card card-body  rounded-lg shadow-md px-4 w-80 bg-white p-3 me-lg-n3 me-xxl-n7 mt-n5 ">
  <img src="/images/trustpilot-1.svg" class="light-mode-item h-20px mb-2 w-28" alt="Client-img">
